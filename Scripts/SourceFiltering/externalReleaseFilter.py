...
globals['directory_blacklist'] = [ '.git', '.svn', 'cajun/test', 'quickstart', 'Regression/reports', 'Regression/Polio', 'Regression/NotreDame', 'Regression/Serious_Gaming' ]
...
globals['file_whitelist'] = [ '.gitattributes', '.gitignore', 'eradicationkernel.sln', 'license.txt', 'notices.txt', 'readme.md', 'sconscript', 'sconstruct' ]
