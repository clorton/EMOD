...
namespace Kernel {
    ...
    float ClimateKoppen::humidity_base[][4] = { { 0.75f }, { 0.75f }, { 0.7f, 0.55f, 0.45f, 0.55f }, { 0.45f, 0.55f, 0.7f, 0.55f },
                                                            { 0.45f }, { 0.45f }, { 0.3f }, { 0.3f },
                                                            { 0.75f }, { 0.75f }, { 0.75f }, { 0.7f, 0.55f, 0.45f, 0.55f }, { 0.7f, 0.55f, 0.45f, 0.55f }, { 0.7f, 0.55f, 0.45f, 0.55f }, { 0.45f, 0.55f, 0.7f, 0.55f }, { 0.45f, 0.55f, 0.7f, 0.55f }, { 0.45f, 0.55f, 0.7f, 0.55f },
                                                            { 0.6f }, { 0.6f }, { 0.6f }, { 0.6f }, { 0.7f, 0.55f, 0.45f, 0.55f }, { 0.7f, 0.55f, 0.45f, 0.55f }, { 0.7f, 0.55f, 0.45f, 0.55f }, { 0.45f, 0.55f, 0.7f, 0.55f }, { 0.45f, 0.55f, 0.7f, 0.55f }, { 0.45f, 0.55f, 0.7f, 0.55f }, { 0.45f, 0.55f, 0.7f, 0.55f },
                                                            { 0.6f }, { 0.6f } };
